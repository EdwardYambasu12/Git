...
useEffect(()=>{
	...
	async function eye(){
       ...
       const parser =  await JSON.parse(liner)
			...
			axios.get("https://apiv3.apifootball.com/?action=get_events&withPlayerStats=1&from="+tomorrow_date+"&to="+tomorrow_date+"&timezone="+getTimeZone()+"&APIkey="+api_key)
			.then(res=>{
				var data = res.data
				var important = []
