...
function dom(){
            ...
            .then((res)=>{
                ...
                const fetched =  sessionStorage.getItem("fyer")
    ...
    useEffect(()=>{
        ...
        async function fetcher(){
            ...
            res.player_stats.away.sort(compare_func) 
             ...
             home_mvp = res.player_stats.home.slice(0,3)
             away_mvp = res.player_stats.away.slice(0,3)

             var homer =  home_mvp.map((item)=>{

                   const h = item
                         return(
                                 <div style = {{display : "flex", alignItem : "center"}}><div><h6 className = "text-center">{h.player_rating}</h6><h6>{h.player_name}</h6></div></div>
                            )
                    })
