               ...
               const data = id.data[0]
                setPiper(
                    <div id = "delivery" className = "fixed-top" style = {{overflowY : "auto"}} >
                        <img onClick = {()=>{setPiper("")}} src = {require("../images/R.png")} style = {{width : "30px", height : "30px", marginLeft : "3%"}}></img> 
                        <br></br>
                        ...
                        <div><div><h6>{data.player_complete_name}</h6></div>
                            <div><button className = "btn btn-info">{item.player_rating}.0</button> <p className = "text-secondary">Sportsup Match Ratings</p></div>
                        </div>
                     
                        </div>
                           <div style = {{display : "flex", justifyContent : "space-around", width : "100%"}}><p className = "text-secondary">position : {item.player_position}</p><button className = "btn btn-warning">View Player Profile</button></div>
