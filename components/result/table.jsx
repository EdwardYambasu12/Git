...
useEffect(() => {
    ...
    const fetchStandings = async () => {
        ...
        try {
			...
			const response = await sessionStorage.getItem("table")
		...
		setLive("🔴live")
			...
			if (main_data.stage_name === "Final" || main_data.stage_name === "Round of 16" || main_data.stage_name  === "Quarter-finals" || main_data.stage_name === "Semi-finals" ){
				...
				async function loader(){
					const fetcher = await axios.get("https://apiv3.apifootball.com/?action=get_events&from="+starter+"&to="+today_date+"&league_id="+league_id+"&APIkey="+api)
			...
			//-------------------------------------------------------------------------------------------------------
					...
					////////////////////////////////////////////OVERALL////////////////////////////////////////////////
									...
									return(
												...
												<tr style = {{width : "100%", background : background_, textDecoration : "bold", height :"50px", fontSize :'0.7em', fontWeight : "5px", alignItems : "center"}}>
				...
				if(commencement === "home"){
									return(
												...
												<tr style = {{width : "100%", background : background_, height : "50px", fontSize :'0.7em', textDecoration : "bold", fontWeight : "5px", alignItems : "center"}}>
														<td style = {{width : "7%", background : useable.color}}>{state}</td>
														<td style = {{width : "30%", background : "inherit"}}>{item.team_name}</td>
